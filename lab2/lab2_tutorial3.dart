...
void main(List<String> arguments) {
  ...
  */
  ...
  /* 
    ...
    const name = 'Dhvani';
    message += name;    // 'Hello my name is Dhvani'
    // for lot of concatenation
    final message = StringBuffer();
    message.write('Hello'); 
    message.write(' my name is '); 
    message.write('Dhvani');
    message.toString();   // "Hello my name is Dhvani"
  */

  /* Interpolation
    const name = 'Dhvani';
    const introduction = 'Hello my name is $name';    // 'Hello my name is Dhvani'
  ...
  */
  ...
  /* Mini-exercises
    ...
    3)
      const firstName = "Dhvani";
      const lastName = "Patel";
      const myDetails = "Hello, my name is $firstName $lastName."; //Hello, my name is Dhvani Patel.
  */
