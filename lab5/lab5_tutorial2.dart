...
void main(List<String> arguments) {
  ...
  /*
  final Caroline = Person("Caroline", "Vampire");
  final Bonnie = Student("Bonnie", "Witch");
  final Elena = SchoolBandMember('Elena', 'Vampire');
  final Damon = StudentAthlete('Damon', 'Vampire');
  print(Caroline.fullName);
  print(Bonnie.fullName);
  final historyGrade = Grade.B;
  Bonnie.grades.add(historyGrade);
  final students = [Bonnie, Elena, Damon];
  print(Elena is Object);
  print(Elena is Person);
  print(Elena is Student);
  print(Elena is SchoolBandMember);
  print(Elena is! StudentAthlete);
